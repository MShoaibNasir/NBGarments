        ...
        <div class="container py-4">
            <div class="card shadow-lg border-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="bi bi-plus-circle me-2"></i> Add New Investments</h4>
                    <a href="{{ route('investment.list') }}" class="btn btn-outline-light btn-sm">
                    ...
                    <div class="form-container mx-auto" style="max-width: 600px;">
                        <form action="{{ route('investment.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Invester name" required>
                                @error('name')
