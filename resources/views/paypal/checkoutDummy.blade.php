...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=YOUR_CLIENT_ID&components=buttons,hosted-fields&vault=false&intent=capture"></script>
        ...
        <div class="main-content">
            ...
            <div class="testimonial-column">
                <div class="testimonial">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-text">"I contacted Marketing Consultant, Marvin Mahoney, at KDP for marketing. The strategies they offered were smart and practical. I just wish more analytics or reports were provided throughout the process."</p>
                    <div class="testimonial-author">–Duane Cassidy, Author</div>
                </div>

                <div class="testimonial">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-text">"Honestly, I didn't know what to expect with Jalena, but Erica and her team delivered a great result. The story felt like mine, even though I didn't write every word"</p>
                ...
                <form id="paymentForm">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="text" id="card-number" name="cardNumber" placeholder="1234 1234 1234 1234" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row expiry">
                        <div class="form-group">
                            ...
                            <input type="text" id="expiration-date" name="expiration_date" placeholder="MM" maxlength="4" required>
                        </div>
                    ...
                    <button type="submit" id="card-pay-button" class="payment-button">Pay Now {{$invoice->InvoiceAmount->total_amount}}</button>
            ...
            <div class="testimonial-column">
                <div class="testimonial">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-text">"Marketing support provided by Keystone Digital Press was pretty solid. They ran a few email blasts and helped me with my Amazon page."</p>
                    <div class="testimonial-author">–Brandon McClasky, Author</div>
                </div>

                <div class="testimonial">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-text">"Keystone Digital Press made publishing less scary for me. Alex and his team were responsive and patient will all my questions. I did have to follow up a few times to keep things moving, but they always got back to me."</p>
...
paypal.HostedFields.render({
    ...
    document.getElementById("card-pay-button").addEventListener("click", function (event) {
